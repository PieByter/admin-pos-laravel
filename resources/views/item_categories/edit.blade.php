        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= site_url('jenis-barang/update/' . $jenis['id']) ?>" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="nama" class="form-label"><b>Nama Jenis Barang</b></label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="keterangan" id="keterangan"
                                    ...
                                    value="<?= old('keterangan', $jenis['keterangan']) ?>">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary me-2"><i class="bi bi-save"></i>
                                    Update</button>
                                <a href="<?= site_url('jenis-barang') ?>" class="btn btn-secondary">
