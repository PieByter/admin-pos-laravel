<x-guest-layout title="Admin POS | Forbidden Page">
    <main class="grid min-h-full place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Access Forbidden
            </h1>
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <a href="{{ route('login') }}"
                    ...
                    back home</a>
                <a href="#" class="text-sm font-semibold text-white">Contact support ITS <span
