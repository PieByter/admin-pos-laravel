                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <dl class="row mb-4">
                            ...
                            <dd class="col-sm-7"><?= esc($pembelian['no_faktur']) ?></dd>
                            <dt class="col-sm-5">Tanggal Terbit</dt>
                            <dd class="col-sm-7"><?= esc(formatTanggalIndo($pembelian['tanggal_terbit'])) ?></dd>
                            <dt class="col-sm-5">Supplier</dt>
                            <dd class="col-sm-7"><?= esc($supplier['nama']) ?></dd>
                            <dt class="col-sm-5">Total Harga</dt>
                            <dd class="col-sm-7">Rp. <?= number_format($pembelian['total_harga'], 0, ',', '.') ?></dd>
                            <dt class="col-sm-5">Status</dt>
                            <dd class="col-sm-7">
                                <?php
                                $badge = 'secondary';
                                $statusText = ucfirst($pembelian['status']);
                            ...
                            <dd class="col-sm-7">
                                ...
                                switch ($pembelian['metode_pembayaran']) {
                                    case 'cash':
                            ...
                            <dd class="col-sm-7"><?= esc($pembelian['keterangan']) ?></dd>
                        </dl>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="2" class="fw-bold text-success">Rp.
                                            <span
                                                id="total-harga-label"><?= number_format($pembelian['total_harga'], 0, ',', '.') ?></span>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="mt-2 d-flex justify-content-end gap-2">
                            ...
                            <a href="<?= site_url('pembelian/edit/' . $pembelian['id']) ?>" class="btn btn-warning">
    ...
    <script>
        document.querySelectorAll('.barang-row').forEach(function(row) {
            row.addEventListener('click', function() {
                ...
                let html = `
            <dl class="row">
                <dt class="col-sm-4">Barang</dt><dd class="col-sm-8">${this.children[1].textContent}</dd>
                <dt class="col-sm-4">Satuan</dt><dd class="col-sm-8">${data.nama_satuan ? data.nama_satuan : '-'}</dd>
                <dt class="col-sm-4">Qty</dt><dd class="col-sm-8">${data.qty}</dd>
                <dt class="col-sm-4">Harga Beli</dt><dd class="col-sm-8">Rp. ${parseInt(data.harga_beli).toLocaleString('id-ID')}</dd>
                <dt class="col-sm-4">Subtotal</dt><dd class="col-sm-8">Rp. ${parseInt(data.subtotal).toLocaleString('id-ID')}</dd>
            </dl>
        `;
