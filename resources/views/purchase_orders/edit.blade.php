            ...
            <div class="col-md-9">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-warning text-dark text-center">
                        <h5 class="card-title mb-0"><i class="fas fa-shopping-bag"></i> Form Edit Pembelian</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('purchases.update', $purchaseOrder->id) }}" method="post">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="date" name="issue_date" id="issue_date" class="form-control"
                                        required
                                        value="{{ old('issue_date', $purchaseOrder->issue_date) ? \Carbon\Carbon::parse($purchaseOrder->issue_date)->format('Y-m-d') : '' }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <div class="form-control bg-light" readonly>
                                        ...
                                        <small class="text-muted">
                                            ({{ $purchaseOrder->created_at ? $purchaseOrder->created_at->format('d/m/Y H:i') : '-' }})
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <div class="form-control bg-light" readonly>
                                        {{ $purchaseOrder->updatedBy->username ?? 'Unknown' }}
                                        <small class="text-muted">
                                            ({{ $purchaseOrder->updated_at ? $purchaseOrder->updated_at->format('d/m/Y H:i') : '-' }})
                                        </small>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text"
                                                        ...
                                                        value="{{ number_format($detail->buy_price, 0, ',', '.') }}">
                                                </td>
                                                <td>
                                                    <input type="text"
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="submit" class="btn btn-warning me-2"><i class="fas fa-save"></i>
