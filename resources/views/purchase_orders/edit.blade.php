        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= site_url('pembelian/update/' . $id) ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <input type="date" name="tanggal_terbit" id="tanggal_terbit" class="form-control"
                                        required value="<?= esc($pembelian['tanggal_terbit']) ?>">
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="input-group">
                                        <select name="id_supplier" id="id_supplier" class="form-select" required>
                                            ...
                                            <option value="<?= esc($s['id']) ?>"
                                                <?= $s['id'] == $pembelian['id_supplier'] ? 'selected' : '' ?>>
                                                <?= esc($s['nama']) ?></option>
                                            <?php endif; ?>
                                            <?php endforeach; ?>
                                        </select>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <select name="metode_pembayaran" id="metode_pembayaran" class="form-select"
                                        ...
                                        <option value="cash"
                                            <?= old('metode_pembayaran', $pembelian['metode_pembayaran']) == 'cash' ? 'selected' : '' ?>>
                                            Cash
                                        </option>
                                        <option value="kredit"
                                            <?= old('metode_pembayaran', $pembelian['metode_pembayaran']) == 'kredit' ? 'selected' : '' ?>>
                                            Kredit
                                        </option>
                                        <option value="transfer"
                                            <?= old('metode_pembayaran', $pembelian['metode_pembayaran']) == 'transfer' ? 'selected' : '' ?>>
                                            Transfer
                                        </option>
                                        <option value="debit"
                                            <?= old('metode_pembayaran', $pembelian['metode_pembayaran']) == 'debit' ? 'selected' : '' ?>>
                                            Debit
                                        </option>
                                        <option value="e-wallet"
                                            <?= old('metode_pembayaran', $pembelian['metode_pembayaran']) == 'e-wallet' ? 'selected' : '' ?>>
                                            E-Wallet
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <select name="status" id="status" class="form-select" required>
                                        ...
                                        <option value="draft"
                                            <?= old('status', $pembelian['status']) == 'draft' ? 'selected' : '' ?>>
                                            Draft
                                        </option>
                                        <option value="proses"
                                            <?= old('status', $pembelian['status']) == 'proses' ? 'selected' : '' ?>>
                                            Proses
                                        </option>
                                        <option value="selesai"
                                            <?= old('status', $pembelian['status']) == 'selesai' ? 'selected' : '' ?>>
                                            Selesai (Lunas)
                                        </option>
                                        <option value="utang"
                                            <?= old('status', $pembelian['status']) == 'utang' ? 'selected' : '' ?>>
                                            Utang
                                        </option>
                                        <option value="retur"
                                            <?= old('status', $pembelian['status']) == 'retur' ? 'selected' : '' ?>>
                                            Retur
                                        </option>
                                        <option value="batal"
                                            <?= old('status', $pembelian['status']) == 'batal' ? 'selected' : '' ?>>
                                            Batal
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-9">
                                    <textarea name="keterangan" id="keterangan" class="form-control"><?= esc($pembelian['keterangan']) ?></textarea>
                                </div>
                            </div>
                            <hr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" class="fw-bold text-success">Rp.
                                                <span id="total-harga-label">
                                                    <?= number_format($pembelian['total_harga'] ?? 0, 0, ',', '.') ?>
                                                </span>
                                                <input type="hidden" name="total_harga" id="total-harga"
                                                    value="<?= $pembelian['total_harga'] ?? 0 ?>">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
