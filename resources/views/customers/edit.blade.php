                    ...
                    <div class="card-body">
                        <form action="<?= site_url('customer/update/' . $customer['id']) ?>" method="post">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="alamat" name="alamat" required><?= old('alamat', $customer['alamat']) ?></textarea>
                                </div>
                            </div>
                            <div class="row mb-3 align-items-center">
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="keterangan" name="keterangan" required><?= old('keterangan', $customer['keterangan']) ?></textarea>
                                </div>
                            </div>
